 ...
 * org.eclipse.equinox.http.jetty.context.path=/controller_server
 ...
 * eclipse.product=edu.hkcc.pacmanrobot.controller.server.product
 */
public class ServerApplication implements IApplication {
  ...
  public Object start(IApplicationContext context) throws Exception {
    ...
    */
    logger.info("controller server initialized");
    return EXIT_OK;
  }
