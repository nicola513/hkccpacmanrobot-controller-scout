...
import edu.hkcc.pacmanrobot.controller.client.LoginForm.MainBox.UserInfoBox.RobotIdField;
...
public class LoginForm extends AbstractForm {
  ...
  /**
   * @return the RobotIdField
   */
  public RobotIdField getRobotIdField() {
    return getFieldByClass(RobotIdField.class);
  }
    ...
    public class UserInfoBox extends AbstractGroupBox {
      ...
      public class UsernameField extends AbstractTextField {
        ...
        protected String execValidateValue(String rawValue) throws ProcessingException {
          ...
          if (rawValue.length() == 0) throw new ProcessingException("User name cannot be empty");
          return super.execValidateValue(rawValue);
        }
      }

      @Order(20.0)
      public class RobotIdField extends AbstractTextField {

        @Override
        protected String getConfiguredLabel() {
          return TEXTS.get("RobotId");
        }
      }
    }
