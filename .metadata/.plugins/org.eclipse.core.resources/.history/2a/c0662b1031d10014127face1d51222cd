...
public class LoginFormData extends AbstractFormData {
  ...
  public RobotId getRobotId() {
    return getFieldByClass(RobotId.class);
  }
  ...
  public static class RobotId extends AbstractValueFieldData<String> {
